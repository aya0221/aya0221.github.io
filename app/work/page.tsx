  ...
  },
  {
    ...
    description: (
      <ul className="list-disc pl-5">
        ...
        <li>Fine-tuned <strong>DistilBERT</strong> achieving <strong>99.8% intent classification accuracy</strong> and fine-tuned a <strong>RoBERTa-based spaCy Transformer NER model</strong> reaching <strong>99.97% F1-score</strong>.</li>
